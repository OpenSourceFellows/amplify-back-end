...
// Creating 'from' variable here to capture the address_id generated by the follwoing /createAdress test
// for the /createLetter test. While it'd be preferable to not have tests depend on
// each other, this will ensure a consitently correct address_id and should the test address_id
